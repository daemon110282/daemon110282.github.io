...
Чтобы снизить риск [MiTM](../../ability/security/risk/mitm.md) применяется:
...
- End-to-End TLS (шифрование до backend-сервера, без расшифровки на proxy)
  ...
  - Минусы:
    ...
    - Сложнее инспектировать трафик на уровне систем: не могут анализировать зашифрованные данные:
