...
Обеспечить достижение атрибутов качества архитектуры ПО - [характеристика производительности](../../ability/performance/performance.md).
...
- [Репликация](../integration/sync.data.md)
- Кластеризация
