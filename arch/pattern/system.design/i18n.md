...
- ICU (International Components for Unicode)
  - набор библиотек и стандартов для интернационализации (i18n), который решает ключевые задачи локализации:
    - форматирование дат, чисел, валют
    - работа с Unicode
    - самое важное — MessageFormat для переводов с логикой
