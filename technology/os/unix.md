...
3. Настроить вход на Linux рабочую станцию для пользователей домена, причём желательно [SSO](../../arch/sso.md) (чтобы часто не вводить длинный пароль).
...
- [SSO](../../arch/sso.md) - single sign-on
